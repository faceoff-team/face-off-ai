...
global_path = '/Users/dommiller88/Documents/GitHub/face-off-ai/model/tests/testing_data'
emotions = {
    0: 'fear',
    1: 'happy',
    2: 'neutral',
...
def test_1():
    ...
    total = 0
    for i in range(4):
        path = f'/Users/dommiller88/Documents/GitHub/face-off-ai/model/tests/testing_data/test_1/{emotions[i]}'
        cur_score = 0
